...
class OrderApplicationServiceTest {
    ...
    private var orderDomainService = OrderDomainServiceImpl()
    ...
    fun `test Create Order`() {
        ...
        `when`(restaurantRepository.findRestaurantInformation(orderCommandToRestaurant)).thenReturn(restaurantResponse)
        ...
        assertNotNull(createOrderResponse.trackingId)
