...
object Meta {
    ...
    val GROUP = "eu.kakde.personal.projects.food-ordering-system"
    val ARTIFACT_ID = "version-catalog"
    val VERSION = "1.0.4" // VERSION OF THE LIBRARY THAT WILL BE PUBLISHED TO REPO.
    ...
    val GITHUB_REPO = "ani2fun/food-ordering-system.git"
